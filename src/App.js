...
export default function App() {
  ...
  const initialWatched = localStorage.getItem("watched");
  const initialWatchedList = initialWatched ? JSON.parse(initialWatched) : [];

  const [watched, setWatched] = useState(initialWatchedList);
